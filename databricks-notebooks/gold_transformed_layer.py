...
gold_dim_patient = "abfss://<<container>>@<<storageaccount_name>>.dfs.core.windows.net/dim_tbl_patient"
gold_dim_department = "abfss://<<container>>@<<storageaccount_name>>.dfs.core.windows.net/dim_tbl_department"
gold_fact = "abfss://<<container>>@<<storageaccount_name>>.dfs.core.windows.net/fact_tbl_patient_flow"
