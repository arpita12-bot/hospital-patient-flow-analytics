...
EVENTHUBS_NAMESPACE = "hospital-analytics-de-namespace.servicebus.windows.net"  # "<<NAMESPACE_HOSTNAME>>"
EVENT_HUB_NAME="hospital-analytics-eh"                                          #"<<EVENT_HUB_NAME>>"
CONNECTION_STRING = "Endpoint=sb://hospital-analytics-de-namespace.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=nO0aYbyafCQw6S7hdJz3J9+mQeBFrdFgH+AEhBZifkQ="                           #"<<NAMESPACE_CONNECTION_STRING>>"
